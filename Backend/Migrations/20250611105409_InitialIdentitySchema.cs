        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailAuditLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Success = table.Column<bool>(type: "boolean", nullable: false),
                    Is2FASuccess = table.Column<bool>(type: "boolean", nullable: true),
                    FailureReason = table.Column<string>(type: "text", nullable: true),
                    DeviceName = table.Column<string>(type: "text", nullable: true),
                    IsTrustedDevice = table.Column<bool>(type: "boolean", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TrustedDeviceId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DeviceIdentifier = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    TrustedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserRoleAssignmentId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    RoleId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ModuleAccessControlId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    RoleId = table.Column<string>(type: "text", nullable: false),
                    ModuleId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModuleAccessControls", x => x.ModuleAccessControlId);
                    table.ForeignKey(
                        name: "FK_ModuleAccessControls_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModuleAccessControls_Modules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailAuditLogs_TemplateType",
                table: "EmailAuditLogs",
                column: "TemplateType");

            migrationBuilder.CreateIndex(
                name: "IX_EmailAuditLogs_ToEmail",
                table: "EmailAuditLogs",
                column: "ToEmail");

            migrationBuilder.CreateIndex(
                name: "IX_EmailAuditLogs_UserId",
                table: "EmailAuditLogs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_LoginAuditLogs_LoginTime",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoginAuditLogs_UserId_Success_LoginTime",
                table: "LoginAuditLogs",
                columns: new[] { "UserId", "Success", "LoginTime" });

            migrationBuilder.CreateIndex(
                name: "IX_ModuleAccessControls_ModuleId_RoleId",
                table: "ModuleAccessControls",
                columns: new[] { "ModuleId", "RoleId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ModuleAccessControls_RoleId",
                table: "ModuleAccessControls",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrustedDevices_DeviceIdentifier",
                table: "TrustedDevices",
                column: "DeviceIdentifier",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TrustedDevices_UserId_DeviceIdentifier",
                table: "TrustedDevices",
